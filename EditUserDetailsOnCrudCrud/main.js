...
function bookAppoiment(event){
   ...
   // const t = event.target.time.value;
    ...
    axios.post("https://crudcrud.com/api/dedf8141111f43d783da38e2a95b8ca2/userDetails",userInfo)
    .then((res)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
    axios.get("https://crudcrud.com/api/dedf8141111f43d783da38e2a95b8ca2/userDetails")
        .then((response) => {
  ...
  function showuserInfo(user){
   ...
   function deleteUser(userId){
    axios.delete(`https://crudcrud.com/api/dedf8141111f43d783da38e2a95b8ca2/userDetails/${userId}`)
    .then((response) => {
        console.log(response)
