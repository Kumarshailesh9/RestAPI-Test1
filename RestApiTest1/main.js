function expensiveTracker(e){
    ...
    axios
    .post('https://crudcrud.com/api/2392f10f243941adaefacd21b8dfda80/products',productInfo)
    .then((res)=>{
          console.log(res)
...
window.addEventListener('DOMContentLoaded',()=>{
    axios
    .get('https://crudcrud.com/api/2392f10f243941adaefacd21b8dfda80/products')
    .then((res)=>{
...
function deletePro(userId,cost){
    total = (total-cost);
    axios
    .delete(`https://crudcrud.com/api/2392f10f243941adaefacd21b8dfda80/products/${userId}`)
    .then((res)=>{
        removeScreen(userId)
        console.log(res)
        scrtotal(total);
